...
import type { AppThunk, RootState } from "@/stores/store"
...
export const incrementAsync = createAsyncThunk(
  // This is action type prefix, which will be used to generate action types like `counter/fetchCount/pending`, etc...
  "counter/fetchCount",
  async (amount: number) => {
